...
BP 链接以京东为例：`https://p.m.jd.com/norder/order.action?wareId=100033551654&wareNum=1&enterOrder=true`。其中，`wareId=100012043978`中`100012043978`是商品 ITEM ID，`Num=1`中 1 是购买数量。
