...
[KPSourceForgeUpdateChecker](https://sourceforge.net/projects/kpsfupdatechecker/reviews) 可以帮助检查 KeePass 及其插件是否有更新，功能从「KeePass 菜单栏 - 帮助 - 检查更新」进入，会使用 SourceForge 上的插件更新信息。
