...
article: false
title: 必备应用
description: 正在寻找好用的Windows软件？这份必备应用清单为你精心筛选了从知识管理到设计开发的各类工具。无论你是效率达人还是开发者，都能在这里找到优化工作流的最佳选择。
icon: fa6-solid:list
---

本页主要记录 Windows 自用软件。有关安卓应用及相关解答，请查看[安卓应用](https://newzone.top/apps/android.html)。

## 知识记录

本地笔记：Obsidian & 妙笔 & Logseq & Joplin ~~& Wiz 笔记 & OneNote~~
...
文字识别：白描 OCR & [TTime](https://github.com/inkTimeRecord/TTime) & [pot](https://github.com/pot-app/pot-desktop) ~~& 天若 OCR & ABBYY Screenshot Reader OCR~~

AI 本地客户端：[AnythingLLM](https://anythingllm.com/) & [LM Studio](https://lmstudio.ai/)
...
截图：Snipaste & PixPin & ShareX ~~& webshot & SETUNA~~
...
视频剪辑：CapCut（剪映海外版） & LosslessCut(音频提取·视频切割合并) & [ShanaEncoder](https://shana.pe.kr/shanaencoder_download/)(视频压缩) & [Quick Cut](https://github.com/HaujetZhao/QuickCut) (自动剪辑) & HandBrake(视频转换) & Premiere ~~& Shotcut & 500th Video Converter & 小丸工具箱~~
...
换脸特效：~~Snap Camera~~（已于 2023 年停服）、[Avatarify Python](https://github.com/alievk/avatarify)
...
投屏工具：[scrcpy](https://newzone.top/posts/2019-08-26-scrcpy_screen_projection.html) (手机投屏) & [Macast](https://gitee.com/xfangfang/Macast/releases/)（手机视频投屏到电脑）& [letsview](https://letsview.cn/)（电脑投电视，免费版足够）

串流：[Moonlight](https://github.com/moonlight-stream/moonlight-android/releases)（控制端/TV）& [Sunshine](https://github.com/LizardByte/Sunshine/releases)（被控端/PC）
...
[AltSnap](https://github.com/RamonUnch/AltSnap)：按住 alt 键，鼠标不需要点标题栏，左键点击窗口的任意位置拖动即可拖动窗口。(Powertoys 已内置该功能)
...
局域网传输：[LocalSend](https://github.com/localsend/localsend/blob/main/README_ZH.md) & [Snapdrop](https://meta.appinn.net/t/topic/31209/1) & [FastCopy](https://fastcopy.jp/)~~& 局域网通讯 (酷安) & Send Anywhere & Pushbullet~~
...
网盘同步：坚果云 & 阿里云盘 & 百度网盘 & 115 ([转存脚本](https://github.com/Nerver4Ever/SevenSha1UIAdvancedHelper)) ~~& 亿方云 & 金山快盘 & 微云~~

## 系统日常

资源管理器：[One Commander](https://www.onecommander.com/) & Files App & [Q-Dir](https://www.softwareok.com/?seite=Freeware/Q-Dir) & FreeCommander & QTTabBar（Win10） ~~& 360 文件夹 & Clover（UI 不好看）~~
...
[UniGetUI](https://github.com/marticliment/UniGetUI)：原名 WingetUI，为 Windows 包管理器设计的直观 GUI，可用于下载、安装、更新和卸载支持的包管理器上发布的软件，支持包括 Winget、Scoop、Chocolatey、Pip、Npm、.NET Tool 和 PowerShell 库。
...
系统优化：[PowerToys](https://github.com/microsoft/PowerToys)、[RBTray](https://github.com/benbuck/rbtray)（最小化到托盘）、[ContextMenuManager](https://github.com/BluePointLilac/ContextMenuManager)(右键管理，遇过 bug，推荐火绒右键)、WizTree（磁盘空间分析）、优效日历、StartIsBack++、[O&O ShutUp10++](https://www.oo-software.com/en/shutup10)、Dism++、[Windows Update Blocker](https://www.sordum.org/downloads/?st-windows-update-blocker)（阻止系统更新）

## 低频工具

编程工具：[MobaXTerm](https://github.com/RipplePiam/MobaXterm-Chinese-Simplified)（SSH+FTP）、[WaveTerm](https://github.com/wavetermdev/waveterm)、GitHubDesktop、Postman、FileZilla（FTP）、DBeaver([数据库](https://kalacloud.com/blog/best-mysql-gui-tools/))、Fiddler(手机抓包)、Regex Match Tracer

翻译词典：DeepL & 新华字典 ~~& GoldenDict & 欧陆词典 & 有道词典 & QTranslate & Lingoes~~

思维导图：TheBrain(无限思维扩展) & Xmind ~~& MindManager~~

网络检测：[NetQuality](https://github.com/xykt/NetQuality)（WSL/Linux）
