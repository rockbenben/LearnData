...
article: false
title: 平面设计
description: 想提升设计效率？本文为你精选多款设计利器：从Excalidraw等电子白板，到Eagle图片管理，再到海量免费可商用字体。一站式解决你的设计灵感与工具需求。
...
![](https://img.newzone.top/2023-01-23-20-53-36.png?imageMogr2/format/webp "手绘样例")
...
- 妙笔白板：支持聚合图片、文本、表格、清单、看板和 Excalidraw，但根据作者回复，妙笔的连接线和分组功能会在 2023 的下半年才摆上开发计划。
...
- [华为鸿蒙字体](https://developer.huawei.com/consumer/cn/doc/design-guides-V1/font-0000001157868583-V1)：简称「HarmonyOS Sans」，是华为鸿蒙系统的内置字体，由汉仪操刀制作。支持包含简繁中文、拉丁、西里尔、希腊、阿拉伯等 5 大书写系统，是一款多语言的无级可变字体，可以免费商用。
...
字体格式建议 OTC > OTF > TTC > TTF，如果只在 Windows 平台使用，TTC/TTF 体验更佳。如果你是一名设计师并进行大量的印刷设计，你可以使用 Adobe 软件进行大量工作。在这种情况下，建议使用 OTF 字体，因为 .otf 是基于 postscript(类似于 PDF) 并由 Adobe 开发。OTF 格式还提供了更多风格的替代方案和字距调整选项，设计师可能会觉得这些选项有用。如果你使用 MS Office 进行大量工作时，建议使用 TTF 字体，因为 .ttf 是由 Microsoft 和 Apple 开发的。例如：你只能将.ttf 字体嵌入到 MS Word 和 MS PowerPoint 中，而不能嵌入 .otf 字体。
