...
article: false
title: HTML
description: 前端开发者的HTML实用宝典。涵盖相对路径、字符实体等基础知识，精选实用JS插件与CSS布局技巧。从Bootstrap响应式布局到代码压缩工具，助你全面提升网页与移动端开发效率。
...
- [list.js](https://github.com/javve/list.js)：实时搜索页面，并直接显示结果页面。为列表、表格或其他任何 HTML 标签增加了搜索，排序，过滤器和灵活性等元素。网页中会自动将大段空格压缩为一个空格，不用特意替换。
...
<div id="mobile" style="text-align:center;display: none;">
  <img src="https://iluminage-cdn.oss-cn-shanghai.aliyuncs.com/upload/202108/1628149761.png" />
</div>
```
